...
function event_frog_col_object(
 ...
 elseif obj.t=="acorn" then
  ...
  obj.delete=true
  add(inventory, {t=obj.t,sp=obj.sp})
 elseif obj.t=="squir" then
  acorni=find_in_inv("acorn")
  if acorni!=nil then
   sfx(0)
   deli(inventory,acorni)
  end
 end
end
...
function round_wall_corners(r)
 for dx=0,15 do
  for dy=0,15 do
   ...
   -- carpet franjes
   if sp==27 then
    local smask=surroundings(dx,dy,27,r)

    -- corners
    if (smask&0b010100000)==0 then
     sspr(72,0,4,4,8*dx,8*dy)
    end
    if (smask&0b010001000)==0 then
     sspr(76,0,4,4,8*dx+4,8*dy)
    end
    if (smask&0b000100010)==0 then
     sspr(72,4,4,4,8*dx,8*dy+4)
    end
    if (smask&0b000001010)==0 then
     sspr(76,4,4,4,8*dx+4,8*dy+4)
    end

--    if (smask&0b000100000)==0 then
--     sspr(80,8,4,4,8*dx,8*dy)
--     sspr(80,12,4,4,8*dx,8*dy+4)
--    end
--    if (smask&0b000001000)==0 then
--     sspr(84,8,4,4,8*dx+4,8*dy)
--     sspr(84,12,4,4,8*dx+4,8*dy+4)
--    end
--    if (smask&0b010000000)==0 then
--     sspr(80,0,4,4,8*dx,8*dy)
--     sspr(84,0,4,4,8*dx+4,8*dy)
--    end
--    if (smask&0b000000010)==0 then
--     sspr(80,4,4,4,8*dx,8*dy+4)
--     sspr(84,4,4,4,8*dx+4,8*dy+4)
--    end
   end
  end
 end
...
__gfx__

